...
foreach (string name in studentNames)
{
    ...
    if (currentStudent.Equals("Sophia")) studentScores = sophiaScores;

    // assign Andrews's score to the studentScores array
    else if (currentStudent.Equals("Andrew")) studentScores = andrewScores;

    // assign Emma's scores to the studentScores array
    else if(currentStudent.Equals("Emma")) studentScores = emmaScores;

    // assign Logan's scores to the studentScores array
    else if(currentStudent.Equals("Logan")) studentScores = loganScores;

    // assign Becky's scores to the studentScores array
    else if(currentStudent.Equals("Becky")) studentScores = beckyScores;

    // assign Chris's scores to the studentScores array
    else if(currentStudent.Equals("Chris")) studentScores = chrisScores;

    // assign Eric's scores to the studentScores array
    else if(currentStudent.Equals("Eric")) studentScores = ericScores;

    // assign Gregor's scores to the studentScores array
    else if(currentStudent.Equals("Gregor")) studentScores = gregorScores;
    ...
    // intialize/reset the calculated average of exam + exam credit scores
